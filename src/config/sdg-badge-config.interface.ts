 ...
 *
 * Values in standard Dublin Core metadata fields may be a goal number (for example
...
export interface SDGBadgeConfig {
  ...
  /**
   * Built-in Discovery filter used to count matching outputs. The default
   * `subject` filter indexes `dc.subject` in a standard DSpace installation.
   */
